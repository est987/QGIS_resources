...
##Map Server
services_m=['retzef_tamamim_ikari_raster']

for s in services_m:
    QgsSettings().setValue('qgis/connections-arcgismapserver/{}/url'.format(s), 'https://ags.iplan.gov.il/arcgisiplan/rest/services/PlanningPublic/{}/MapServer/'.format(s))
    iface.reloadConnections()
